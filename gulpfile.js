...
const defaultTasks = gulp.series(jshintTask, server, frontExpose, ga, views, frontMin, sassMin);
const devTasks = gulp.series(jshintTask, server, frontExpose, copyStressTest, ga, views, frontFull, sassFull);

function watch() {
    gulp.watch('src/shared/**/*.js', gulp.series(jshintTask, server, frontFull));
    gulp.watch('src/client/**/*.js', gulp.series(jshintTask, frontFull));
    gulp.watch('src/server/**/*.js', gulp.series(jshintTask, server));
...
gulp.task('watch', gulp.series(devTasks, watch));
